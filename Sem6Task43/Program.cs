...
// Берем коэффиценты для уравнений прямых.
...
// Выводим координаты точек пересечения округляя до 3 знака.
...
// подсчитываем площадь и выводим.
...
{
    double[] result = new double[2]; // создаем массив.
...
double TakeDoubleData(string msg) //метод считывающий вещественное число из консоли, выводит сообщение.
{
    Console.Write(msg);
...
{
    double[] result = new double[2]; // создаем массив для координат точки.
