...
string str = TakeData("Введите выражение для расчета: "); // считываем выражение 
...
// выводим результат используя созданный метод. 
// Символ действий над числами получаем из исходной строки, обратившись
